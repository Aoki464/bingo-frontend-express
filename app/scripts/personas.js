 ...
 */
 ...
 angular.module('PersonaApp', ['ngGrid']).controller('PersonaCtrl', function ($scope, $http, $location) {
    $scope.venta = null;
    $scope.awesomeThings = [
      'HTML5 Boilerplate',
      'AngularJS',
    ...
    $scope.getPagedDataAsync = function (pageSize, page, searchText) {
      setTimeout(function () {
        ...
        if (searchText) {
          ...
          $http.get('Data/personas.json').success(function (largeLoad) {
     ...
     $scope.gridOptions = {
        data:  'myData',
         //El campo Field debe coincidir con su ubicacion dentro de la respuesta Json
           columnDefs: [
         {field: 'tipoDocumento', displayName: 'Tipo de documento'},
         {field: 'identificacion', displayName: 'Identificacion'},
